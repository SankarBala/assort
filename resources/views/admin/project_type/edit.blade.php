...
@section('content')
    <div class="container mamb_edit">
        ...
        <div class="card shadow mb-4">
            <div class="card-header text-center"><i class="fas fa-edit"></i> Project Type Edit</div><!--/.card-header-->
            <div class="card-body">
                ...
                <form name="form1" method="POST" action="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10"><input type="text" name="project_type_name" class="form-control"
                                id="text" placeholder="" value="Ongoing Projects"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10"><input type="text" name="project_type_slug" class="form-control"
                                id="text" placeholder="" value="ongoing-projects"></div>
                    </div>
        ...
        <a href="/project-type-details/1/index.html">
