...
@section('content')
    <div class="container mamb_add">
        ...
        <div class="card shadow mb-4">
            <div class="card-header text-center"><i class="fas fa-plus-circle"></i> Add Area</div><!--/.card-header-->
            <div class="card-body">

                <form name="form1" method="POST" enctype="multipart/form-data" action="{{ route('admin.area.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-2">
