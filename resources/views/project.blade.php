...
<hr/>
                <div class="row mt-2">
                    <div class="col-lg-6 col-12 mb-4">
                        <div class="">
                            <img id="project_photo" loading="lazy" class="img-fluid" src="{{ asset($project->photo) }}"
                                alt="img">
                        </div>
                    ...
                    <div class="col-lg-6 col-12 mb-4">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr><td>City</td><td>{{$project->location->name}}</td></tr>
                                <tr><td>Area</td><td>{{$project->area->name}}</td></tr>
                                <tr><td>Address</td><td>{{$project->address}}</td></tr>
                                <tr><td>Flat Size</td><td>{{$project->flat_size}}</td></tr>
                                <tr><td>Height</td><td>{{$project->height}}</td></tr>
                                <tr><td>Lift Available</td><td>{{$project->lift}}</td></tr>
